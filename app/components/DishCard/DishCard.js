...
const dishCard = (props) => {
  ...
  return (
      ...
      <View elevation={5}   style={styles.dishCard} >
        ...
        <TouchableOpacity onPress={props.onRecommendButtonPressed} style={{padding:4}}><LikeIcon fill={'#ffa000'} height={26} width={26}/></TouchableOpacity>
        <TouchableOpacity onPress={props.onReviewButtonPressed} style={{padding:4}}><PenIcon fill={'#ffa000'} height={26} width={26}/></TouchableOpacity>
        <TouchableOpacity onPress={props.onRatingButtonPressed} style={{padding:4}}><StarIcon fill={'#ffa000'} height={27} width={26}/></TouchableOpacity>
        </View>
        <View style={{flexDirection: 'row'}}>
        <Text style={{ color: '#212121', fontFamily: 'OpenSans-Bold', fontSize: 22, marginLeft: 10}}>{props.dish_name}</Text>
       
        </View>
        <Text style={{ color: '#757575', fontFamily: 'OpenSans-SemiBold', fontSize: 12, marginLeft: 10,}}>Rs. {props.price}</Text>
        <Text style={{ color: '#757575', fontFamily: 'OpenSans-SemiBold', fontSize: 12, marginLeft: 10,}}>{props.restaurant_name}</Text>
        <Text style={{ color: '#212121', fontFamily: 'OpenSans-Bold', fontSize: 18,marginLeft: 10,marginTop:5,marginBottom:2}}>Reviews</Text>
        <FlatList 
          data = {props.reviews}
          renderItem = { (item) => {
            return(
